...
public class TransactionService {
     ...
     *  - The whole method is one @Transactional unit â€” either both balances update and both
    ...
    public TransactionResponse transfer(TransferRequest request, Authentication authentication) {
        ...
        // idempotency check â€” if this exact request already ran, hand back the original result
    ...
    /**
     * Deposit money into one of the current user's own accounts â€” simulates
